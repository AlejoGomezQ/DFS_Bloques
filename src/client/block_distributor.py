...
class BlockDistributor:
    ...
    """
    def __init__(self, namenode_client: NameNodeClient, replication_factor: int = 2):
        """
    ...
    def select_datanodes_for_block(self, block_size: int) -> List[Dict]:
        """
        ...
        eligible_datanodes.sort(key=lambda dn: dn.get('available_space', 0), reverse=True)
